          ...
          return _c("div", { staticClass: "card-body" }, [
            _c("div", {
              ...
              attrs: {
                id: "doughnut-chart",
                "data-colors":
                  '["#000421", "#ffcc5a", "#34c38f", "#16daf1", "#f04d80"]',
              },
            }),
          ])
        },
            ...
            _c("div", { staticClass: "card-body" }, [
              _c("div", {
                ...
                attrs: {
                  ...
                  "data-colors":
                    '["#34c38f", "#f04d80", "#16daf1", "#ffcc5a", "#000421"]',
                },
              }),
            ]),
          ]),
...
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {
      ...
      var map = {
        ...
        "./components/backend/components/SearchInputComponent.vue": "./resources/js/components/backend/components/SearchInputComponent.vue",
        "./components/backend/components/breadcrumbComponent.vue": "./resources/js/components/backend/components/breadcrumbComponent.vue",
        "./components/backend/components/charts/edoughnutChartComponent.vue": "./resources/js/components/backend/components/charts/edoughnutChartComponent.vue",
        ...
        "./components/backend/components/tableFooterComponent.vue": "./resources/js/components/backend/components/tableFooterComponent.vue",
        ...
        "./components/backend/pages/service/ServiceFormComponent.vue": "./resources/js/components/backend/pages/service/ServiceFormComponent.vue",
        "./components/backend/pages/service/ServiceTable.vue": "./resources/js/components/backend/pages/service/ServiceTable.vue",
        "./components/backend/pages/service/ServicesComponent.vue": "./resources/js/components/backend/pages/service/ServicesComponent.vue",
        "./components/backend/pages/user/UsersComponent.vue": "./resources/js/components/backend/pages/user/UsersComponent.vue",
        "./components/backend/pages/user/UsersTable.vue": "./resources/js/components/backend/pages/user/UsersTable.vue",
